    ...
    <div className="min-h-screen pt-20 bg-[#f5f4ef]">
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <p className="text-gray-700 leading-relaxed text-lg">
          Māte Nātre is a forest bar nestled within the RAA cultural space in
          Riga&apos;s central district. Drawing inspiration from the Baltic
          forest, we craft drinks from wild herbs, berries, and botanicals
          gathered with care. Our space is light, unhurried, and alive with the
          ...
          transformed into something that tastes like a walk in the Baltic
          forest. Find us at Matīsa iela 8, inside Radošā rūpnīca Veldze.
        </p>
